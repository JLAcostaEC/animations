...
<PerspectiveBook size="lg" textured {textureUrl} class="bg-[#5f4638] text-stone-100">
	<div class="flex h-full flex-col justify-between">
		...
		<div class="space-y-1">
			<p class="text-[0.65rem] font-semibold tracking-[0.28em] text-stone-200/70 uppercase">
				Spell Collection
			</p>
